...
# api_office_v3_snapshot (still in this module) aggregates via a direct call to the
# agents list handler; keep that name resolvable now it lives in the agents router.
