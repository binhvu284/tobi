...
# api_office_v3_snapshot (still in this module) aggregates via direct calls to the
# agents + missions list handlers; keep those names resolvable now they live in
# their routers.
...
# ── WORKFLOWS / OFFICE STATS (Mission Control §4) ─────────────────────────────
...
@app.get("/api/office/v3/snapshot")
...
@app.get("/api/office/artifacts/{artifact_id}")
...
@app.post("/api/office/v3/actions/propose")
