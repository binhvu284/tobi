...
import { getEvolution, type EvolutionReport } from '../api.abilities'
import { getOfficeStats, type OfficeStats } from '../api.office'
import { pmListProjects, type PMProject } from '../api.pm'
