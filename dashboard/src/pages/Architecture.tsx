  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        label: 'Google',
        logo: 'google',
        desc: 'Google Workspace (Drive, Gmail, Calendar) via OAuth2. After saving client ID/secret, click "Connect with Google" to authorize.',
        file: 'core/integrations.py',
        tags: ['OAuth2', 'Drive', 'Gmail', 'Calendar'],
      },
    ],
  },
]
