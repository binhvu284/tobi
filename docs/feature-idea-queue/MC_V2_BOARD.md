...
**In progress.** T00 through T06 are complete, T07 Runs 1-2A are accepted, Run 2B is delivered, and T07 remains open.

**Delivered:** 7 complete packages plus T07 Runs 1-2B, about **76-84%** of total effort.

**Next:** review and accept T07 Run 2B, then plan Run 3 for terminal execution. The first bounded file
write now requires an expected current hash, records one before/after receipt, replays completed
duplicates without writing again, and blocks uncertain retries until file evidence proves the outcome.
No live routing or owner-visible behavior changed.
...
| T07 | **Move the first real tools over:** files, terminal, projects. Each mutation gets a receipt, and a retry cannot double-apply it. | T03, T06 | High | Runs 1-2A accepted; Run 2B delivered; review |
