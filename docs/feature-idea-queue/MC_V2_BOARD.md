...
**In progress.** T00 through T04 and T05 Run 1 are delivered; T05 Run 2 planning is next.

**Delivered:** 5 of 17 packages plus about 25-35% of T05, about **54-60%** of total effort.

**Next:** T05 Run 2 plans durable owner approvals. Run 1 added typed deterministic policy results
and immutable redacted `mc_policy_decisions`, but the default-off policy flag has no live caller.
Conductor, terminal, MCP, Vault, Chat, and Agent behavior is unchanged.
...
| T05 | **One place decides what is allowed.** Permissions, approvals, credentials, budgets — currently spread across many files. | T01 | High | Run 1 delivered; Run 2 next |
