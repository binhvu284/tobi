...
> Queue snapshot refreshed 2026-08-26. #21 and #33 are committed and green at `a317604`.
> #34/T00 is owner-accepted; T01 through T06 are green. T07 is technically green and waits for owner dashboard acceptance.

| # | ID | Name | Description | Status | Notes |
|---|----|------|-------------|--------|-------|
| 34 | `UPG-CORE-2D12H-011` | [**TOBIval Operational Intelligence and Model Independence**](TOBIVAL_OPERATIONAL_INTELLIGENCE_PLAN.md) | Real exams prove TOBI's quality, while common MC work relies less on the selected model. | 🟠 In progress (owner acceptance required) | T07 technical proof is green: 72/72 cases, 14/14 holdouts, ECR `100`, LDR `2.0312`, strong/weak/no-model completion `100%`, zero critical/fabricated/duplicate failures, 156 approved Codex subscription calls, `$0` direct spend, and `25/25` inherited gate suites. The Evaluations page shows the bounded result and keeps release blocked by `owner-acceptance-required`. #34 moves to Done only after owner dashboard acceptance. [history](QUEUE_DELIVERY_LOG.md#item-34) |
