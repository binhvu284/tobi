...
/* The shell left these two paragraphs on the browser's default margin (1em); Mission
   Control's reset zeroes paragraph margins, which pressed them against what sits above. */
.ui2 .lastrun{margin:14px 0 0}
.ui2 .boothint{margin:12px 0 0}
`
